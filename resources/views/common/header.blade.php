                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0 mob-menu2">
                            ...
                            @foreach ($result as $nav)
                                ...
                                @endswitch
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" id="{{ $nav['parentid'] . 'dropdownMenuLink' }}" data-bs-toggle="dropdown" aria-expanded="false"
                                        href= "#">
                                        {{ $nav['parent_name'] }}
                                    </a>
                                    <ul class="dropdown-menu" aria-labelledby="{{ $nav['parentid'] . 'dropdownMenuLink' }}">
                                        @foreach ($nav['children'] as $subnav)
                                            <li><a class="dropdown-item"
                                                    href="{{ $urlpre . $subnav['child_slug'] }}.html">{{ $subnav['child_name'] }}</a>
                                            </li>
