                    ...
                    <div class="col-md-4 col-sm-12 plr-0">
                        <div class="column-inner">
                            <div class="column-wrapper">
                                ...
                                <p class="banner-txt" style="text-align:justfy">{!! substr($cities->shortdesc,0,145) !!}</p>
                                <div class="view-box">
                    ...
                    <div class="col-md-3 plr-0 flex-none">
                        <div class="column-inner">
                            <div class="column-wrapper">
                                ...
                                <div class="banner-txt" style="text-align:justfy"> {!! substr($routes->shortdesc,0,175) !!} </div>
                                <div class="view-box">
